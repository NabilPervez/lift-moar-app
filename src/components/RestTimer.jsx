...
export default function RestTimer({ seconds, total, onDismiss, onAdjust }) {
  ...
  return (
    <div className="fixed bottom-16 left-0 right-0 z-30 px-4 pointer-events-none">
      <div className="max-w-md mx-auto pointer-events-auto slide-up bg-surface-700/95 backdrop-blur rounded-2xl border border-blue-500/30 shadow-2xl shadow-black/50 p-3 flex items-center gap-3">
